...
public class SearchPageImpl extends PageObjectFacadeImpl {
    ...
    public void verifyMustHaveBoxContains(String item) {
        Assert.assertTrue("'Must Have' box should contain " + item + ", but it does not.",getMustHaveBox().findElement(By.xpath("./div/button[contains(text(),'"+ item +"')]")).isDisplayed());
    }
    ...
    public void verifyNiceToHaveBoxContains(String item) {
        Assert.assertTrue("'Nice to Have' box should contain " + item + ", but it does not.",getNiceToHaveBox().findElement(By.xpath("./div/button[contains(text(),'"+ item +"')]")).isDisplayed());//.getText().contains(item.toUpperCase()));
    }
    ...
    public void verifyNiceToHaveBoxDoesNotContain(String item) {
        try {
            ...
            Assert.assertTrue("'Nice to Have' box should not contain " + item + ", but it does.", !(getNiceToHaveBox().getText().contains(item)));
        } catch (org.openqa.selenium.NoSuchElementException nsee) {
