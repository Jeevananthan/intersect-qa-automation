...
public class RepVisitsPageStepDefs implements En {
    ...
    public RepVisitsPageStepDefs() {
        ...
        And("^HS I should be able to see the text - #HE User# has asked for feedback on their recent visit.- in every entry present in Visit Feedback Pending tab$", repVisits::verifyTextInformingThatHEUserHasAskedFeedbackAboutTheirVisitIsPresentInEachEntryInVisitFeedbackPendingTab);
    }
}
