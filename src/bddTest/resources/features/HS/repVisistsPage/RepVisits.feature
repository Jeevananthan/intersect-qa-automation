...
#      |Tuesday          | 5             |07          | 12             | 8             | pm                | pm              | 99         | August 15 2017       |September 23 2017 |
  ...
  @MATCH-3462
  Scenario: As a RepVisits HS user that is interested in opting in to connect events with Naviance,
  I want the copy on the screen to clearly provide me with information on my ability to opt in/out of the publish connection,
