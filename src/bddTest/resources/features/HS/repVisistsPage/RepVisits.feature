...
#Post-Condition
 ...
 @MATCH-2436
  ...
  @MATCH-1581
  Scenario Outline:As a high school user, I need to be able to view my overall availability
...
#Blocked Days
    ...
    Then HS I verify the diagonal HashLines present in the Blocked date "<BlockedDate>"
    Then HS I click the Remove option for the "<BlockedDate>" and "<EndDate>" in blocked days
    Then HS I remove the Time Slot created with "<StartDate>","<StartTime>" in Regular Weekly Hours Tab
...
#Max Appointments Met Day
 ...
 #Fully Booked Day
    ...
    Examples:
      |Day|StartDate|EndDate |StartTime|EndTime |heStartTime|NumVisits|School              |MaxNumVisits|MaxstartTime|MaxhestartTime|MaxEndTime|PartiallyNumVisits|PartiallystartTime|PartiallyhestartTime|PartiallyEndTime |FullyNumVisits|FullystartTime|FullyhestartTime|FullyEndTime|FullyBookedStartDate|FullyBookedEndDate|BlockedDate|
      |28 |28       |49      |10:41am  |12:59pm |10:        |4        |Int Qa High School 4|4           |12:         |12:           |12:59pm   |5                 |12:               |12:                 |12:59pm          |2             |12:           |12:             |12:59pm     |14                  |35                |42         |
