...
#verify Log history
   ...
   #postcondition
    ...
    Examples:
      ...
      |purpleheautomation+Ampublishing@gmail.com|Match Support UI QA4|active Match-Nonadmin(publishing)|Auburn University Main Campus |7   |11:      |12:25pm |3        |7        |42      |12:25pm      |No, I want to manually review all incoming requests. |Yes, accept all incoming requests.|Standalone High School 6|11:         |11:     |QAs Fairs tests       |7   |0900AM    |1000AM  |5            |$25 |25                    |100                        | Save          |
