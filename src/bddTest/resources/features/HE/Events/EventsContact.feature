...
Feature: HE - Events - Verify Events functionality
  ...
  Scenario: As a HE User, I want to Add a Contact so that to create Event I select added contact
   ...
   |Contact Name| AdelphiContact102|
   |Contact Email| contact6@adelphi.com |
   |Contact Number| 513-746-2344 |
    And HE I select save button
    And HE I verify "AdelphiContact102" present  in the contact list
  ...
  Scenario: As a HE User, I want to delete a Contact that is associated with Unpublished event
    ...
    And HE I click on New Contact link
    And HE Enter Following Data to create Contact
      |Contact Name| AdelphiContact30|
      |Contact Email| contact@adelphi.com |
      |Contact Number| 513-746-2344 |
    And HE I select save button
    And HE I click on box Enter Primary Contact and enter text "AdelphiContact30"
